...
public class Main_backup extends Application {
    ArrayList<GrafiekenschermController_backup> grafiekenSchermen = new ArrayList<>();
    int grafiekenIndex = 0;
    Stage mainWindow;
    Scene mainScene;
    MainController mainController;
    GrafiekenschermController_backup grafiekenschermControllerBackup;
    Scene candlesticksSchermScene;
    Stage pfStage;

    PortefeuillebeheerController_backup pfController;
    Scene pfScene;
    ...
    public void start(Stage stage) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("mainwindow_backup.fxml"));
    ...
    public void toonGrafiekenscherm(String gekozenMarkt, String gekozenAandeel, int aantalBeursdagen,
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("grafiekenscherm_backup.fxml"));
        Parent grafiekenRoot = loader.load();
        grafiekenschermControllerBackup = loader.getController();
        grafiekenschermControllerBackup.main = this;
        grafiekenschermControllerBackup.setFondsnaam(gekozenAandeel);
        ...
        grafiekenschermControllerBackup.setCandleStickClassObject(candlestickClassObject);

        // Set het chart object in de grafiekenschermControllerBackup en zet tevens in dat
        // chart object de referentie naar de grafiekenschermControllerBackup (dus wederzijdse link).

        grafiekenschermControllerBackup.createCandleChart(gekozenAandeel);

        grafiekenSchermen.add(grafiekenschermControllerBackup);

        grafiekenschermControllerBackup.setIndex(grafiekenIndex);
    ...
    */
    public void beursdagNaarRechts(int grafiekenIndex) {
        for (GrafiekenschermController_backup gc: grafiekenSchermen) {
